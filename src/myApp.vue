...
<template>
  <head>
    ...
    <meta name="description" content= "A basic responsive web page from chapter 1" />
    <link rel="stylesheet" href="src/assets/styles.css" />
  </head>
    <body>
        <div class="Header">
          <a href="/" class="LogoWrapper">
            <img src="src/assets/SOC-Logo.png" alt="Scone O'Clock logo"/>
          </a>
          <h1 class="Strap">Scones: the most resplendent of snacks
            <p></p>
          </h1>
        </div>
